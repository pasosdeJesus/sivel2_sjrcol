class CreateTrivalentepositiva < ActiveRecord::Migration[6.0]
  def up
    ...
    execute <<-EOF
            INSERT INTO trivalentepositiva (id, nombre, fechacreacion, fechadeshabilitacion, created_at, updated_at) VALUES (0, 'SIN RESPUESTA', '2020-02-27', NULL, '2020-02-27', '2020-02-27');
