...
CREATE RULE "_RETURN" AS
    ON SELECT TO sivel2_sjr_ultimaatencion DO INSTEAD  SELECT sivel2_sjr_respuesta.id_caso,
    sivel2_sjr_respuesta.id,
    min(sivel2_sjr_respuesta.fechaatencion) AS fechaatencion,
  ...
  GROUP BY sivel2_sjr_respuesta.id_caso, sivel2_sjr_respuesta.id;
