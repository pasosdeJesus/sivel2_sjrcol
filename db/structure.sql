...
CREATE VIEW public.cmunex AS
 SELECT ( SELECT sip_pais.nombre
   ...
   FROM public.sivel2_sjr_desplazamiento desplazamiento,
    ...
    public.sivel2_gen_victima victima,
    public.sivel2_sjr_casosjr casosjr
  WHERE ((casosjr.id_caso = desplazamiento.id_caso) AND (desplazamiento.id_caso = victima.id_caso) AND (casosjr.oficina_id = 7) AND (desplazamiento.id_expulsion = ubicacion.id));
...
CREATE VIEW public.cmunrec AS
 SELECT ( SELECT sip_pais.nombre
   ...
   FROM public.sivel2_sjr_desplazamiento desplazamiento,
    ...
    public.sivel2_gen_victima victima,
    public.sivel2_sjr_casosjr casosjr
  WHERE ((casosjr.id_caso = desplazamiento.id_caso) AND (desplazamiento.id_caso = victima.id_caso) AND (casosjr.oficina_id = 7) AND (desplazamiento.id_llegada = ubicacion.id));
...
CREATE VIEW public.cvp1 AS
 SELECT respuesta.id AS id_respuesta,
  ...
  WHERE ((respuesta.id_caso = casosjr.id_caso) AND (derecho_respuesta.id_respuesta = respuesta.id) AND (derecho_respuesta.id_derecho = 2));
...
CREATE VIEW public.cvp2 AS
 SELECT ar.id_respuesta,
  ...
  WHERE (ar.id_ayudasjr = ad.ayudasjr_id);
