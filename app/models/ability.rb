  ...
  CAMPOS_PLANTILLAS_PROPIAS = {
    ...
    'Consgifmm' => {
      campos: [
          ...
          'beneficiarios_nuevos_colombianos_retornados_ids',
          'beneficiarios_nuevos_mes',
          'beneficiarios_nuevos_mes_ids',
          'beneficiarios_nuevos_en_transito',
          'beneficiarios_nuevos_en_transito_ids',
          'beneficiarios_nuevos_pendulares',
          'beneficiarios_nuevos_pendulares_ids',
          'beneficiarios_nuevos_vocacion_permanencia',
          'beneficiarios_nuevos_vocacion_permanencia_ids',
